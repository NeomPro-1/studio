  ...
  return (
    <div className="space-y-8">
        <div className="text-center">
            <h1 className="text-3xl font-bold font-headline">Annuity Calculator</h1>
            <p className="text-muted-foreground mt-2">Calculate the monthly payout from your lump-sum investment.</p>
        </div>
            ...
            <div className="lg:col-span-2 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                    ...
                    <Card>
                     ...
                     <Card>
                        <CardHeader>
                            <CardDescription>Monthly Payout</CardDescription>
        ...
        <Card>
            <CardHeader>
                <CardTitle>About Annuity Calculator</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
                <p>
                    An annuity is a financial product that provides a stream of regular payments in exchange for a lump-sum investment. This calculator helps you determine the fixed monthly payout you can receive from your investment over a specified period. It is an essential tool for retirement planning, allowing you to see how your savings can be converted into a reliable source of income to cover your living expenses.
                </p>

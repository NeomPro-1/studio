  ...
  return (
    <div className="space-y-8">
        <div className="text-center">
            <h1 className="text-3xl font-bold font-headline">FD Calculator</h1>
            <p className="text-muted-foreground mt-2">Calculate the maturity value of your Fixed Deposit.</p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                 ...
                 <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Projected growth of your FD over {timePeriod} years.</CardDescription>
                    </CardHeader>
                    <CardContent>

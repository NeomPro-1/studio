    ...
    <div className="space-y-8">
        ...
        <Card>
            ...
            <CardContent className="space-y-4">
                <p>
                    A Step-up SIP, or a top-up SIP, allows you to increase your monthly investment amount by a fixed percentage annually. This aligns your investments with your growing income, helping you reach your financial goals much faster. This calculator shows the significant impact of making small, regular increases to your SIP contributions over time, supercharging the power of compounding.
                </p>
